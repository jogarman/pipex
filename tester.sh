...
echo "Para probar el tester, haz por ejemplo: ./pipex infile cat "grep 1" outfile_tester"
echo "el tester no comprueba leaks ni bonus. Lee la parte comentada de este código" 
...
# Probar a meter un comando con /usr/bin/ls por ejemplo
# Hacer "unset PATH" y probar que hace lo mismo
# borrar outfile y o infile
# quitar accesos a infile y outfile
# Comprobar que ha creado oufile con permisos -rw-r--r-- (644)
# Comprobar como comando "NULL"
# Comprobar que el parseo tiene más de 4 argumentos (5 con bonus)


# en bonus comprobar que hace append y no trunc
# meter más comandos 
# probar que el "EOF" lo coge sin espacios delante ni detrás
